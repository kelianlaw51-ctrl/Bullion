            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">privacy@bullioncourier.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">+1 (555) 123-COURIER</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">123 Delivery Street<br />Courier City, CC 12345</p>
                </div>
              </div>
            </div>
          </div>
